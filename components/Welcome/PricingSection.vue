              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 text-colour">$9.99 </div><p class="text-colour">monthly</p>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
              ...
              <v-col class="col-12 col-md-4">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 text-colour">$19.99</div><p class="text-colour">monthly</p>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
